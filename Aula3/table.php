...
<body>
    <?php
        ...
        array_filter($pessoas, function($pessoa){
           ...
           /* if(((stripos($pessoa['nome'], $_GET['nome'] > -1)) || (empty($_GET['nome']))) 
            && ((stripos($pessoa['cidade'], $_GET['cidade'] > -1)) || (empty($_GET['cidade'] )))
            && ( $idade == $_GET['idade'] || (empty($idade))) 
            && ((empty ($_GET['estado'])) || $_GET['estado'] == $pessoa['estado'])){

                echo "oi";
                return true;
            }*/

            if(( $idade == $_GET['idade'] || (empty($idade))) ){
                echo "oi";
            }
        });
